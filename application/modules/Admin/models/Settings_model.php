...
// update general settings
		function update_settings() {
				...
				$data = array('offline_message' => $this->input->post('offlinemsg'),'rss' => $this->input->post('rss'),'default_theme' => $this->input->post('theme'),'site_offline' => intval($this->input->post('site_offine')), 'site_title' => $this->input->post('site_title'),
					...
					'allow_supplier_registration' => intval($this->input->post('allow_supplier_registration')), 'multi_curr' => intval($this->input->post('multicurr')), 'updates_check' => intval($this->input->post('updates')), 'restrict_website' => $this->input->post('restrict'),'mapApi' => $mapApi );
				$this->db->where('user', 'webadmin');
				$this->db->update('pt_app_settings', $data);
