...
if ( ! function_exists('getHeaderMenu'))
{
    function getHeaderMenu($lang_set)
    {
      ...
      if(!empty($res)){
        ...
        $result->pagesInfo[] = (object)array('id' => $hm->id,'title' =>  $parent['pagetitle'],
    ...
    exit;*/
               $result = array();
                ...
                if($pagesinfo->content_special == '1'){
                  ...
                  $arrayFrom = array("ean","flightsdohop","cartrawler","travelstart","hotelscombined","wegoflights");
                  $arrayTo = array("hotels","flightsd","car","flightst","hotelsc","flightsw");
