...
defined('EXIT__AUTO_MAX')      OR define('EXIT__AUTO_MAX', 125); // highest automatically-assigned error code
 ...
 /*******My constants*******/
    ...
    define('PT_VERSION', 'v6');
    define('PT_LINK', 'http://phptravels.com');
    define('PT_SHOW', '1');
    define('PT_STARS_ICON', "<i class='star icon'></i>");
    define('PT_EMPTY_STARS_ICON', "<i class='empty star icon'></i>");
   ...
   define("LOADING_ICON","assets/img/loading.svg'");
